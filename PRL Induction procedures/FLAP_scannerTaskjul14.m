...
try
    ...
    Screen('FrameOval', w,gray, imageRect_offsCImask2, 90, 90); %mask
    Screen('FrameOval', w,gray, imageRect_offsCImask1, 90, 90); %mask
    ...
    for totalblock=1:totalactiveblock
        ...
        for trial=1:10
            ...
            if blocktype==1 %gabors
                ...
                %imageRectMask = CenterRect([0, 0, [ xs*1.75*pix_deg xs*1.75*pix_deg)*1.5651]], wRect);
                imageRect_offsCImask1=[imageRectMask(1)+theeccentricity_XCI, imageRectMask(2)+theeccentricity_YCI,...
