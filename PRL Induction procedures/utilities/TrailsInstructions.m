...
switch Block
    ...
    case 3
        DrawFormattedText(w, 'There will be numbers and letters in circles on the next page. \n \n Please click on the circles alternating in order between letters and numbers. \n \n Start at number 1, then go to the first letter A. \n \n Please respond as quickly and accurately as you can. \n \n Lets practice \n \n \n \n Hit any key to start the next block.', 'center', 'center', LetterColor);
