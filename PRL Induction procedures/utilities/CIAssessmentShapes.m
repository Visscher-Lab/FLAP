...
Targx{1}= [xfoo; -xfoo];
Targy{1}= [yfoo; yfoo];
Targori{1}=[  60   225   180   135    90    90    90   135   180   225    70
             -60  -225   180  -135    90    90    90  -135   180  -225   -70 ];
offsetx{1}= [-Xoff; Xoff];
offsety{1}=[-Yoff; -Yoff];

% d vs p
Targx{2}= [ -2    -2    -2    -1    -1     0     0     1     1     2     2     2      2      2     2
            -2    -2    -2    -1    -1     0     0     1     1     2     2     2     -2     -2     -2];
Targy{2} = [-1     0     1    -2     2    -2     2    -2     2    -1     0     1     -2     -3     -4
            -1     0     1    -2     2    -2     2    -2     2    -1     0     1     2     3     4];
Targori{2} =[30     0   150    60   120    90    90   120    60   150     0    30     0     0     0
