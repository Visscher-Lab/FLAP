...
Xoff= [-0.1563  -0.0950      0   -0.1800       0       0       0    0.1700       0    0.1913    0.1700];
Yoff= [-0.1288  -0.1900      0    0.1288       0       0       0   -0.1275       0    0.2126    0.0850];
% Xoff= [-0.1575  -0.0975      0   -0.1800       0       0       0    0.1700       0    0.1913    0.1700];
% Yoff= [-0.1495  -0.1950      0    0.1288       0       0       0   -0.1275       0    0.2126    0.0850];
Targx{2}= [xfoo; -xfoo];
Targy{2}= [yfoo; yfoo];
...
% d vs p
Targx{1}= [  -2    -2    -2    -1    -1     0     0     1     1     2     2     2      2      2     2
             -2    -2    -2    -1    -1     0     0     1     1     2     2     2     -2     -2     -2];
Targy{1} = [-1     0     1    -2     2    -2     2    -2     2    -1     0     1     -2     -3     -4
            -1     0     1    -2     2    -2     2    -2     2    -1     0     1     2     3     4];
Targori{1} =[30     0   150    60   120    90    90   120    60   150     0    30     0     0     0
