...
switch EyetrackerType
    case 1 % EyeLink
        ...
        case 2 % VPixx
        [SummaryData EyeTrackerData ErrorData] = CheckTrackerpixx(EyetrackerType,whicheye,ScreenHeightPix,ScreenWidthPix,driftoffsetx,driftoffsety,ViewpointRefresh,0,datapixxtime);
