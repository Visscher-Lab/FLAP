...
if inward==1
    if fixation_location_prl ==1 ||fixation_location_url==1 %we are showing x fixation aids em ps pd 11/14 (change orientation of fixation aids based on location of stimulus presentation)
    ...
    elseif fixation_location_prl ==2 ||fixation_location_url==2 %we are showing t shape fixation aids
