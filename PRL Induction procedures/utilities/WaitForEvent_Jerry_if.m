function [Bpress, RespTime, TheButtons, bin_buttonpress, inter_buttonpress, starttime] = WaitForEvent_Jerry_if(responseduration,starttime,TargList, Bpress, TheButtons, RespTime,timestamp, binaryvals,inter_buttonpress, bin_buttonpress, inter_timestamp)
...
%counter=0;
Datapixx('RegWrRd');
if ((Datapixx('GetTime') < (starttime + responseduration)) && ~Bpress)
