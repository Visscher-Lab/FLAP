function [Bpress, RespTime, TheButtons, bin_buttonpress, inter_buttonpress] = DontWaitForEvent_Jerry3(TargList, Bpress, TheButtons, RespTime,timestamp, binaryvals,inter_buttonpress, bin_buttonpress, inter_timestamp)
