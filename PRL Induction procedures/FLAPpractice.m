...
for trial=1:length(Jitpracticearray)
    Orijit=Jitpracticearray(trial);
    stimulusdurationpractice=stimulusdurationpracticearray(trial);
...
practiceresp(trial)=resp;
end
    % do we exit the practice loop?
performance=sum(practiceresp)/trial;
