...
gaborcontrast=0.5;
    ...
    if EyetrackerType==1
        ...
        eyeTrackerBaseName =[SUBJECT '_DAY_' num2str(expday) '_CAT_' num2str(c(1)-2000) '_' num2str(c(2)) '_' num2str(c(3)) '_' num2str(c(4)) '_' num2str(c(5))];
...
%             Targori=90+[0  0 45 90 135  0 135  90 45 0 0 90
%                 135 0 0   90 45 0 45 90 135  0 0 135];

%                 Targori=90+[0  0 45 90 90  0 90  90 0 0 0 90
%                 135 0 0   90 45 0 45 90 135  0 0 135];
            
                Targori=90+[0  0 45 90 90  0 45  90 0 0 0 90
                135 0 0   90 45 0 45 90 135  0 0 135];    
...
%                                     
%                                     
                             imageRect_offsCI =[imageRect(1)+(newsamplex-wRect(3)/2)+eccentricity_XCI', imageRect(2)+(newsampley-wRect(4)/2)+eccentricity_YCI',...
    imageRect(3)+(newsamplex-wRect(3)/2)+eccentricity_XCI', imageRect(4)+(newsampley-wRect(4)/2)+eccentricity_YCI'];       
...
%     Screen('DrawTextures', w, theLetter, [], imageRect_offs' + [xJitLoc+xModLoc; yJitLoc+yModLoc; xJitLoc+xModLoc; yJitLoc+yModLoc], theori,[], Tcontr );
 ...
 imageRect_offsCI3(setdiff(1:length(imageRect_offsCI),targetcord2),:)=0;
     Screen('DrawTextures', w, TheGaborsSmall, [], imageRect_offsCI3' + [xJitLoc+xModLoc; yJitLoc+yModLoc; xJitLoc+xModLoc; yJitLoc+yModLoc], theori,[], Tcontr );
