...
try
    ...
    triangleformation= 0; % three stimuli
    ...
    %angles= [25 50 75 125 150 175 -25 -50 -75 -125 -150 -175];%205-360 230-360 255-360 280-360 305-360 330-360 ];
