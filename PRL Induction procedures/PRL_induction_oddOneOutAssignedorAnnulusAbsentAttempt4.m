...
[img, sss, alpha] = imread('/Users/sll/Desktop/Flap/stimuli_inductionii/TGT_1.png');
img(:, :, 4) = alpha;
Happyface = Screen('MakeTexture', w, img);


[img, sss, alpha] = imread('/Users/sll/Desktop/Flap/stimuli_inductionii/OT_1.png');
img(:, :, 4) = alpha;
...
[img, sss, alpha] =imread('neutral.png');
img(:, :, 4) = alpha;
