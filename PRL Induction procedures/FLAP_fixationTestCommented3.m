...
try
    ...
    for trial=1:length(mixtr)
        ...
        while eyechecked<1
            ...
            if (eyetime2-trial_time)>= ifi*2+pretargettime && fixating>400 && stopchecking>1 && counterannulus<AnnulusTime/ifi && counterflicker<FlickerTime/ifi && flickerdone<1 && keyCode(escapeKey) ==0 && (eyetime2-trial_time)<=trialTimeout
            ...
            elseif (eyetime2-trial_time)>= ifi*2+pretargettime && fixating>400 && stopchecking>1 && flickerdone<1  && counterannulus<AnnulusTime/ifi && counterflicker<FlickerTime/ifi && keyCode(escapeKey) ~=0 && (eyetime2-trial_time)<=trialTimeout
                %HERE if I press ESC
                thekeys = find(keyCode);
                closescript=1;
                break;
            elseif (eyetime2-newtrialtime)>= ifi*2+pretargettime && fixating>400 && stopchecking>1 &&  skipcounterannulus>10  && counterflicker<FlickerTime/ifi && (eyetime2-trial_time)<=trialTimeout && keyCode(escapeKey) ==0
