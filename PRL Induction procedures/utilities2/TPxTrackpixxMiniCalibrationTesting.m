function TPxTrackpixxMiniCalibrationTesting()
% TPxTrackpixxMiniCalibrationTesting()
%
% This demo calibrates the current session for the TRACKPixx /mini tracker
% in remote mode and shows you the results of the calibration. Once the
...
%multi screen.
screenNumber = 1; %3 originally


TPxCalibrationTesting(0,screenNumber)
