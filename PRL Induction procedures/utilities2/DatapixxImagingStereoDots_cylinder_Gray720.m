function DatapixxImagingStereoDots_cylinder_Gray720()
% Prior to running this demo, the 'edid' command in VPutil
% should be ran to put the PROPixx in 1280x720@240Hz.

% Dec 1, 2015  dml     Written
% Mar 15, 2018  dml     Revised
