   ...
   % stepsizesCW=[4 4 3 3 2 2 1];
    ...
    if PRLlocations==2
        ...
        if coin==1
            ...
            mixtrCW=[ones(tr_per_condition*2,1) [ones(tr_per_condition,1); ones(tr_per_condition,1)*2]];
        else
            %radial and tangential dx first
            mixtrCW=[ones(tr_per_condition*2,1)*2 [ones(tr_per_condition,1); ones(tr_per_condition,1)*2]];
        end
        %attention
