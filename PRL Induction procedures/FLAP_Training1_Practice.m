%% FLAP CI practice version 2
 ...
 %% Added instructions - MGR 5-30-2024       
Screen('TextFont',w, 'Arial');
Screen('TextSize',w, 42);

DrawFormattedText(w, 'Now, we will practice the find the blob task \n \n Please keep your eyes in the center of the screen', 'center', 'center', white);
Screen('Flip', w);
KbQueueWait;
