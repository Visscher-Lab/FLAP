...
try
    ...
    baseName=['./data/' SUBJECT '_DAY_' num2str(expday) '_PRL_induction_oddoneout_' num2str(scotomadeg) ' deg ' num2str(c(1)-2000) '_' num2str(c(2)) '_' num2str(c(3)) '_' num2str(c(4)) '_' num2str(c(5))]; %makes unique filename
