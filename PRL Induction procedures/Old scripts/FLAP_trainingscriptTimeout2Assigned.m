    ...
    for trial=1:length(mixtr)
        ...
        while eyechecked<1
            ...
            elseif (eyetime2-trial_time)>=waittime+ifi*2+cueonset+cueduration+cueISI && fixating>400 && stopchecking>1 && counterannulus<AnnulusTime/ifi && counterflicker<FlickerTime/ifi && keyCode(escapeKey) ~=0 && (eyetime2-pretrial_time)<=trialTimeout
                ...
                break;
                %             clear annulusend
            elseif (eyetime2-trial_time)>=waittime+ifi*2+cueonset+cueduration+cueISI && fixating>400 && stopchecking>1 && counterannulus>=AnnulusTime/ifi && counterflicker<FlickerTime/ifi && (eyetime2-pretrial_time)<=trialTimeout
                if trainingType>2
