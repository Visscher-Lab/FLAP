...
try
    ...
    % read csv file and extract relevant parameters for this participant
    temp= readtable(participantAssignmentTable);
    SUBJECT = answer{1,:}; %Gets Subject Name
   % tt = temp(find(contains(temp.participant,SUBJECT)),:); %em removed x___ in front of x____participant 11/15/2023
        tt = temp(find(contains(temp.x___participant ,SUBJECT)),:); %em removed x___ in front of x____participant 11/15/2023
