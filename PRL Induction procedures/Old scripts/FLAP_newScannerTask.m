% FLAP Scanner task
% written by Marcello A. Maniglia Nov 2022 %2017/2021
...
try
    prompt={'Participant Name', 'day','site? UCR(1), UAB(2), Vpixx(3)', 'TRL location (1: left, 2: right)', 'Demo? (1:yes, 2:no)', 'Eye? left(1) or right(2)', 'Calibration? yes (1), no(0)', 'Scotoma? yes (1), no(0)', 'Eyetracker(1) or mouse(0)?'};
