...
cueonset=0.5; % time between first O and the cue
    ...
    for trial=1:totalmixtr
        ...
        while eyechecked<1
            ...
            if (eyetime2-trial_time)>=0 && (eyetime2-trial_time)<ifi*3
            ...
            elseif (eyetime2-trial_time)>=ifi*4 && (eyetime2-trial_time)<trialonsettime+ifi*2 && fixating>400 && stopchecking>1
            ...
            elseif (eyetime2-trial_time)>=trialonsettime+ifi*2+cueonset && (eyetime2-trial_time)<trialonsettime+ifi*2+cueonset+currentcueduration && fixating>400 && stopchecking>1 && (eyetime2-pretrial_time)<=trialTimeout
                % present cue
            ...
            elseif (eyetime2-trial_time)>=trialonsettime+ifi*2+cueonset+currentcueduration && (eyetime2-trial_time)<trialonsettime+ifi*2+cueonset+currentcueduration+currentcueISI && fixating>400 && stopchecking>1 && (eyetime2-pretrial_time)<=trialTimeout
                % cue-target ISI
                tk=0;
            elseif (eyetime2-trial_time)>=trialonsettime+ifi*2+cueonset+currentcueduration+currentcueISI && (eyetime2-trial_time)<=trialonsettime+ifi*2+cueonset+currentcueduration+currentcueISI+presentationtime && fixating>400 && stopchecking>1 && (eyetime2-pretrial_time)<=trialTimeout
                % show target
                tk=tk+1;
                showt(trial)=99;
                if exist('targeton')==0
...
%                 end
            ...
            elseif (eyetime2-trial_time)>trialonsettime+ifi*2+cueonset+currentcueduration+currentcueISI+presentationtime && (eyetime2-trial_time)<trialonsettime+ifi*2+cueonset+currentcueduration+currentcueISI+presentationtime+posttargetISIduration && fixating>400 && stopchecking>1 && (eyetime2-pretrial_time)<=trialTimeout%
...
%                 end
            ...
            elseif (eyetime2-trial_time)>=trialonsettime+ifi*2+cueonset+currentcueduration+currentcueISI+presentationtime+posttargetISIduration && (eyetime2-trial_time)<trialonsettime+ifi*2+cueonset+currentcueduration+currentcueISI+presentationtime+posttargetcircleduration+posttargetISIduration && fixating>400 && stopchecking>1 && (eyetime2-pretrial_time)<=trialTimeout%
            ...
            elseif (eyetime2-trial_time)>=trialonsettime+ifi*2+cueonset+currentcueduration+currentcueISI+presentationtime+posttargetcircleduration+posttargetISIduration && fixating>400 && stopchecking>1 && (eyetime2-pretrial_time)<=trialTimeout%
