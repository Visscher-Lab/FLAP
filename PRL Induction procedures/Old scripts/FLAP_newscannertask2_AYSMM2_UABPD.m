...
try
   ...
   if demo==0
    ...
    if EyeTracker==1
        if site==3 || site==5 || site==6 %PD added site==6 here and she will remember to take site6 out before the actual scan 8/17/23
    ...
    TRcount = 0;
    %% Demo
    %     if demo==1 %PD added this part 8/15/23
    %         mixtr=mixtr(1:10,:);
    %     end
    ...
    for trial=1:length(mixtr)
        ...
        if responsebox==1
            ...
            %     starttime=Datapixx('GetTime');
            % end
            if site==3 %PD: originally site~=5, changed to site==3. PD will remember to change this site==3 before the actual scan
