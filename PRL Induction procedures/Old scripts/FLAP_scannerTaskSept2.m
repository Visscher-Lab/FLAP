...
try
    prompt={'Subject Name', 'Pre or Post Scan','Run Number','site UCR(1), UAB(2), Vpixx(3)','demo (0) or session (1)','Debug? (1:yes, 2:no)','Eye? left(1) or right(2)', 'Calibration? yes (1), no(0)', 'Scotoma? yes (1), no(0)', 'Eyetracker(1) or mouse(0)?', 'left (1) or right (2) TRL?'};

    name= 'Subject Name';
    numlines=1;
    defaultanswer={'test','1', '1', '3','1','2','1','1','1','1','1' };
...
%         imageRectMask(3)+theeccentricity_XCI2, imageRectMask(4)+theeccentricity_YCI2]; % mask location to the left stimulus
     %% draw everything on the instruction page
      InstructionFLAPscanner(w,wRect,eccentricity_X,eccentricity_Y,TRLlocation,test,pix_deg,pix_deg_vert,gray,white)
