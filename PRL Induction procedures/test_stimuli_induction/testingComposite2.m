...
theLetter_stim{i}=Screen('MakeTexture', window, largerout2);
theRegular_stim{i}=Screen('MakeTexture', window, largerout);
...
while (1) %  loop 
    ...
    Screen('DrawTexture', window, theLetter_stim{i}, [], rr_Letter);
        Screen('DrawTexture', window, theRegular_stim{i}, [], rr_Regular_one);
            Screen('DrawTexture', window, theRegular_stim{i}, [], rr_Regular_two);
