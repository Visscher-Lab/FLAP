...
try
    ...
    baseName=['./data/' SUBJECT 'flap_attention_stream4' expdayeye '_' num2str(c(1)-2000) '_' num2str(c(2)) '_' num2str(c(3)) '_' num2str(c(4)) '_' num2str(c(5))]; %makes unique filename
