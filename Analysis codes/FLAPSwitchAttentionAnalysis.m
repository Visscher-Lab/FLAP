...
CorrPos1to2Miss=0; % kmv note: Corr stands for "Correct"-- nope!  it stands for congruent.
CorrPos1to3Miss=0;
CorrPos1to4Miss=0;
CorrPos2to1Miss=0;
CorrPos2to3Miss=0;
...
%Acc incorrect -- < -- I'm confused. kmv. accuracy?  ?  incorrect accuracy?
meanEndoTo1incAcc
meanEndoAway1incAcc
meanEndoTo2incAcc
meanEndoAway2incAcc
...
mean(RT_exo_congruent)

mean(RT_exo_incongruent)
