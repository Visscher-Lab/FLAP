...
%endo: 80% coherent: meaning: 5 switches coherent, 1 incongruent


% [TRIAL_N TYPE_OF_TRIAL CUE TGT NEXT_TGT ORI CORR RT]
CorrPos1to2=0;
CorrPos1to3=0;
CorrPos1to4=0;
CorrPos2to1=0;
...
for ui=2:length(sss)
    if sss(ui,2)==1
        ...
        elseif sss(ui-1,4)==3 && sss(ui-1,6)==6 && sss(ui,4)==1
            pos3to1=pos3to1+1;
