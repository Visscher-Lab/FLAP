...
print('Flap pilot VAxCrowdingUAB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot VA-attUAB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot CW rad-attAUB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot CW tan-attUAB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot CW ratio x AttUAB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot CW area x AttUAB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot CW ratio x VAUAB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot CW area x VAUAB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot VA_PRLUAB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot VA_PRLUAB_violinRT', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot CW_PRLUAB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print('Flap pilot Att_PRLUAB', '-dpng', '-r300'); %<-Save as PNG with 300 DPI
