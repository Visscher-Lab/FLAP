...
print([ lenom 'VA_polar_angle_acc'], '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print([ lenom 'Crowding_polar_angle_acc'], '-dpng', '-r300'); %<-Save as PNG with 300 DPI
...
print([ lenom 'Attention_polar_angle_acc'], '-dpng', '-r300'); %<-Save as PNG with 300 DPI
