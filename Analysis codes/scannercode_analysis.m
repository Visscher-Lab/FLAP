...
tasks={'gabor','number'};
for i=1:2 %there is 2 active blocks for each task in each run
...
percent_correct_gabor(1,1)=(gabor_num_trues_total*100)/20;percent_correct_gabor(1,2)=(gabor_num_misses_total*100)/20;percent_correct_gabor(1,3)=(gabor_num_falses_total*100)/20;
percent_correct_number(1,1)=(number_num_trues_total*100)/20;percent_correct_number(1,2)=(number_num_misses_total*100)/20;percent_correct_number(1,3)=(number_num_falses_total*100)/20;
